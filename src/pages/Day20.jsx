            ...
            <div className='h-full pt-12 overflow-hidden'>
              <div className='h-full relative border'>
                ...
                <div className='relative w-full h-72'>
                  <img src="https://placehold.co/30x30" alt="" className='h-full w-full object-cover rounded-t-3xl' />
                </div>
                {/* Main Content */}
                <div className='absolute bottom-0 border border-red-500 bg-green-500 w-full h-80 rounded-3xl'>
                  <div className='absolute top-1.5 h-1.5 w-12 rounded-full bg-red-500 transform left-1/2 -translate-x-1/2'></div>
                </div>
              </div>
            </div>
          </PhoneMockup>
