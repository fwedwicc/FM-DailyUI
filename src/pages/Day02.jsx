        ...
        <div className="lg:min-h-screen lg:px-48 md:px-32 px-8 lg:py-20 py-8">
          ...
          <div className='mt-12 space-y-4'>
            <div className='flex justify-between items-center'>
              <span className='inline-flex items-center gap-3 text-neutral-300 text-xl'>
            ...
            <div className='grid grid-cols-2 gap-8'>
              <label htmlFor="option-1" className="inline-flex w-full flex-col cursor-pointer items-start gap-4 has-[:checked]:outline-none rounded-lg border has-[:checked]:border-2 border-neutral-700 transition hover:bg-neutral-700/40 has-[:checked]:bg-neutral-700 has-[:checked]:border-neutral-500">
                <div className="flex items-center justify-between border-b border-neutral-600 w-full lg:py-4 py-3 lg:px-8 px-4">
                  <div className='flex lg:gap-3 gap-1.5 items-center'>
                    <input id='option-1' type="radio" name='language' className="w-4 h-4 text-neutral-300 bg-transparent border border-neutral-600 focus:ring-neutral-400 focus:ring-2 cursor-pointer transition duration-300 ease-in-out" />
                ...
                <div className='lg:pt-4 pt-2 pb-4 lg:pb-8 lg:px-8 px-4 w-full'>
              ...
              <label htmlFor="option-2" className="inline-flex w-full flex-col cursor-pointer items-start gap-4 has-[:checked]:outline-none rounded-lg border has-[:checked]:border-2 border-neutral-700 transition hover:bg-neutral-700/40 has-[:checked]:bg-neutral-700 has-[:checked]:border-neutral-500">
                <div className="flex items-center justify-between border-b border-neutral-600 w-full py-4 px-8">
                  <div className='flex gap-3 items-center'>
                    <input id='option-2' type="radio" name='language' className="w-4 h-4 text-neutral-300 bg-neutral-600 border border-neutral-600 focus:ring-neutral-400 focus:ring-2 cursor-pointer transition duration-300 ease-in-out" />
                    <span className='font-medium text-neutral-300'>Plus</span>
                  </div>
                  <span className='font-medium text-neutral-300 px-2.5 py-1 border border-neutral-600 bg-neutral-900/40 rounded-md'>Learn a skill</span>
                </div>
                <div className='pt-4 pb-8 px-8 w-full'>
