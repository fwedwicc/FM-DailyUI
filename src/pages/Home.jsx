...
const Home = () => {
  ...
  const Hero = () => {
    return (
      <main className="relative lg:h-screen h-auto grid lg:grid-cols-2 grid-cols-1">
      ...
      <div className='md:py-12 px-12 flex justify-center items-center'>
        <div className='w-full max-w-2xl space-y-7'>
          ...
          <p className="text-sm leading-relaxed text-center text-green-50/80">
            This section showcases my Daily UI challenge submissions, each meticulously crafted using React and Tailwind CSS. Every design and implementation is originally created by <span className='text-green-500'>Frederick Moreno</span>, reflecting my dedication to improving my skills in front-end development and UI/UX design.
          </p>
          <p className="text-sm leading-relaxed text-center text-green-50/80">
