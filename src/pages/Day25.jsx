  ...
  return (
    ...
    >
      ...
      <main className="relative">
        <img src="https://images.unsplash.com/photo-1610650138161-ef555e34fdf2?q=80&w=2128&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Main Background Wallpaper" className='z-10 absolute object-cover w-full h-full opacity-20 brightness-125 blur-sm' />
        <div className='lg:min-h-screen flex flex-col justify-between p-8 md:gap-20 gap-8'>
          ...
          <div className='flex justify-between items-start z-50'>
            ...
            <div className={`flex items-center gap-8`}>
              <div className='gap-2 flex items-center'>
                <button className='size-11 flex justify-center items-center hover:bg-neutral-500/30 rounded-md focus:ring-2 focus:ring-neutral-700 text-neutral-300 z-50 transition duration-300 ease-in-out'>
                ...
                <button className='mr-3 size-11 flex justify-center items-center hover:bg-neutral-500/30 rounded-md focus:ring-2 focus:ring-neutral-700 text-neutral-300 z-50 transition duration-300 ease-in-out'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 9V4.5M9 9H4.5M9 9 3.75 3.75M9 15v4.5M9 15H4.5M9 15l-5.25 5.25M15 9h4.5M15 9V4.5M15 9l5.25-5.25M15 15h4.5M15 15v4.5m0-4.5 5.25 5.25" />
                  </svg>
                </button>
                <button className='flex gap-4 p-2 pl-5 items-center rounded-full border border-neutral-600 bg-neutral-700/40 backdrop-blur-sm hover:bg-neutral-700/80 transition duration-300 ease-in-out'>
                  <p className='text-neutral-200 text-md'>Frederick</p>
                  <img
                    className="size-10 border-2 ring-2 ring-green-500 border-neutral-700 rounded-full cursor-pointer"
                    src="https://avatars.githubusercontent.com/u/84965567?v=4"
                    alt="Bot Avatar"
                  />
                </button>
              </div>
          ...
          <div className='flex flex-col items-center lg:gap-16 md:gap-12 gap-8 z-50'>
            ...
            <div className='w-full max-w-4xl space-y-4'>
              {/* Search Bar */}
              <div className='flex border border-neutral-600 bg-neutral-700/70 backdrop-blur-md rounded-[0.8rem] p-3 w-full'>
                <InputField
                  styles={'me-3'}
                  id="job"
                  type="text"
                ...
                />
                <Button
                  styles={'me-3 flex items-center px-2 text-neutral-200 bg-neutral-800/30 hover:bg-neutral-800 border-none focus:ring-neutral-200/60'}
                >
              ...
              <div className='flex gap-3.5'>
                {['Indie Music', 'TV Series 2025', 'Sports', 'Study Music Live', 'News 2025'].map((item, index) => (
                  <div className='inline-flex items-center gap-2 rounded-lg text-neutral-300 bg-neutral-800/30 backdrop-blur-sm hover:bg-neutral-700/40 border border-neutral-700/70 px-3 py-1.5 cursor-pointer transition duration-300 ease-in-out' key={index}>
                    {item}
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-5">
            ...
            <div className='flex gap-3 z-50'>
              {[
                ...
                <div className='h-auto py-3 w-24 rounded-xl flex flex-col items-center hover:bg-neutral-500/30 justify-center cursor-pointer transition duration-300 ease-in-out' key={index}>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className='text-neutral-200 size-8'>
          ...
          <div className='grid lg:grid-cols-5 md:grid-cols-2 gap-4 z-50'>
            {/* Netflix Container */}
            <div className='relative backdrop-blur-md border border-neutral-700/70 h-64 p-4 flex flex-col justify-between bg-neutral-700/20 rounded-xl overflow-hidden cursor-pointer'>
            ...
            <div className='relative border border-neutral-700/70 col-span-2 h-64 rounded-xl overflow-hidden cursor-pointer'>
              <img src="https://jasondeegan.com/wp-content/uploads/2024/11/Your-favorite-scene-from-The-Last-of-Us-Part-II-will-be-included-in-the-series.jpg" alt="The Last of Us" className='absolute object-cover z-10 w-full h-full pointer-events-none opacity-90' />
              <div className='absolute -left-10 -top-10 h-[140%] w-[65%] bg-neutral-700/40 z-20 blur-2xl rounded-r-[50rem]' />
