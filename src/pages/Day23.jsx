...
import { AdobeAi, AdobeXd, Figma, Framer, Webflow, Wordpress, Sketch } from '../assets/day23'
          ...
          <div className='lg:col-span-4 md:col-span-3 md:p-10 p-6 col-span-1 flex flex-col justify-between gap-8'>
            ...
            <div className='space-y-7'>
              ...
              <div className='grid lg:grid-cols-4 grid-cols-2 gap-5'>
                {[
                  { id: 'option-1', name: 'Figma', link: "figma.com", logo: Figma },
                  { id: 'option-2', name: 'Adobe XD', link: "adobe.com", logo: AdobeXd },
                  { id: 'option-3', name: 'Framer', link: "framer.com", logo: Framer },
                  { id: 'option-4', name: 'Webflow', link: "webflow.com", logo: Webflow },
                  { id: 'option-7', name: 'Wordpress', link: "wordpress.com", logo: Wordpress },
                  { id: 'option-5', name: 'Adobe Illustrator', link: "adobe.com", logo: AdobeAi },
                  { id: 'option-6', name: 'Sketch', link: "sketch.com", logo: Sketch },
                ].map((item, index) => (
                  <label htmlFor={item.id} className="relative inline-flex cursor-pointer flex-col items-start gap-1 rounded-lg border border-neutral-700 p-6 transition hover:bg-neutral-700/30 has-[:checked]:border-2 has-[:checked]:border-green-500/80" key={index}>
                    ...
                    <div className='flex flex-col items-center justify-center w-full'>
                      <img src={item.logo} alt={item.name} className='size-16 rounded-2xl mb-3' />
